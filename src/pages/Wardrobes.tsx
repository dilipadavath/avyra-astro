...
import WardrobeHero from "@/components/wardrobes/WardrobeHero";
import WardrobeIntro from "@/components/wardrobes/WardrobeIntro";
import WardrobeStructure from "@/components/wardrobes/WardrobeStructure";
import WardrobeHygiene from "@/components/wardrobes/WardrobeHygiene";
import WardrobeFinishes from "@/components/wardrobes/WardrobeFinishes";
import WardrobeCustomization from "@/components/wardrobes/WardrobeCustomization";
import WardrobeComparison from "@/components/wardrobes/WardrobeComparison";
import WardrobePromise from "@/components/wardrobes/WardrobePromise";
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="AVYRA manufactures premium stainless steel and aluminium wardrobes in Hyderabad, Telangana & South India. Custom designs, PU/leather/lacquered finishes. Rust-proof, termite-proof, hygienic storage solutions."
        />
        <meta
          name="keywords"
          content="stainless steel wardrobe Hyderabad, aluminium wardrobe manufacturers, custom wardrobe design India, premium wardrobes Telangana, modular wardrobe Hyderabad"
        />
        ...
        <meta
          property="og:title"
          content="Premium Stainless Steel & Aluminium Wardrobes | AVYRA Hyderabad"
        />
        <meta
          property="og:description"
          content="Custom stainless steel and aluminium wardrobes engineered for durability, hygiene, and modern Indian homes. Premium finishes and hardware."
        />
        ...
        <meta
          name="twitter:title"
          content="Premium Stainless Steel & Aluminium Wardrobes | AVYRA"
        />
        <meta
          name="twitter:description"
          content="Custom stainless steel and aluminium wardrobes in Hyderabad & South India."
        />
        <meta
          name="twitter:image"
          content="https://www.avyra.co.in/images/og-avyra-wardrobes.jpg"
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Service",
            name: "Premium Stainless Steel & Aluminium Wardrobes",
            serviceType: "Custom Wardrobe Manufacturing",
            provider: {
              "@type": "LocalBusiness",
              name: "AVYRA",
            ...
            description:
              "Manufacturing and installation of premium stainless steel and aluminium wardrobes with custom finishes designed for modern Indian homes.",
          })}
        </script>
      </Helmet>
