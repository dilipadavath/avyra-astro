...
import heroKitchen1 from "@/assets/hero-kitchen-1.jpg?url";
import aboutTeamMeeting from "@/assets/about-team-meeting.jpg?url";
import aboutEngineering from "@/assets/about-engineering.jpg?url";
import aboutClientTrust from "@/assets/about-client-trust.jpg?url";
import aboutQualityControl from "@/assets/about-quality-control.jpg?url";
import aboutCustomization from "@/assets/about-customization.jpg?url";
import aboutIndianKitchen from "@/assets/about-indian-kitchen.jpg?url";
import aboutVision from "@/assets/about-vision.jpg?url";
...
const About = () => {
  return (
    <div className="bg-background relative overflow-x-hidden">
      ...
      <div
        className="fixed top-0 left-0 w-screen h-screen opacity-35 pointer-events-none"
        style={{
          backgroundImage: `
